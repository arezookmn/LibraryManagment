...
namespace Entities
{
    public class LibraryDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Book>().ToTable("Borrowers");
        ...
        modelBuilder.Entity<Loan>().HasData(
            new Loan { ID = 1, BookID = 1, BorrowerID = 1, LoanDate = new DateTime(2022, 10, 1), ReturnDate = new DateTime(2022, 10, 15) },
            new Loan { ID = 2, BookID = 2, BorrowerID = 2, LoanDate = new DateTime(2022, 10, 5), ReturnDate = new DateTime(2022, 10, 20) },
            new Loan { ID = 3, BookID = 3, BorrowerID = 3, LoanDate = new DateTime(2022, 10, 3), ReturnDate = new DateTime(2022, 10, 17) },
            new Loan { ID = 4, BookID = 4, BorrowerID = 4, LoanDate = new DateTime(2022, 9, 25), ReturnDate = new DateTime(2022, 10, 10) },
            new Loan { ID = 5, BookID = 5, BorrowerID = 5, LoanDate = new DateTime(2022, 10, 8), ReturnDate = new DateTime(2022, 10, 22) },
            new Loan { ID = 6, BookID = 6, BorrowerID = 6, LoanDate = new DateTime(2022, 10, 12), ReturnDate = new DateTime(2022, 10, 27) }
        );
